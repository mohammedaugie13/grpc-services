...
_POLYNOMIALINPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='PolynomialInput.x', index=0,
...
_POLYNOMIALOUTPUT_RESULT = _descriptor.Descriptor(
  name='Result',
  full_name='PolynomialOutput.Result',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='res_x', full_name='PolynomialOutput.Result.res_x', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='res_y', full_name='PolynomialOutput.Result.res_y', index=1,
...
_POLYNOMIALOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='PolynomialOutput.results', index=0,
  ...
  nested_types=[_POLYNOMIALOUTPUT_RESULT, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_POLYNOMIALOUTPUT_RESULT.containing_type = _POLYNOMIALOUTPUT
_POLYNOMIALOUTPUT.fields_by_name['results'].message_type = _POLYNOMIALOUTPUT_RESULT
...
PolynomialInput = _reflection.GeneratedProtocolMessageType('PolynomialInput', (_message.Message,), {
...
PolynomialOutput = _reflection.GeneratedProtocolMessageType('PolynomialOutput', (_message.Message,), {

  'Result' : _reflection.GeneratedProtocolMessageType('Result', (_message.Message,), {
    'DESCRIPTOR' : _POLYNOMIALOUTPUT_RESULT,
    '__module__' : 'polynomial_pb2'
    # @@protoc_insertion_point(class_scope:PolynomialOutput.Result)
    })
  ,
...
_sym_db.RegisterMessage(PolynomialOutput.Result)
